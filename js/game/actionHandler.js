...
app.initActionHandler = function(){
		app.handleAction = function( data ){ // data is like: ['action name', 'action type', objectID||cords]
			if ( data[0] == 'walk here' ){
				...
				app.findPath(start, end, grid, totalRows, totalCols);
			}
		}
}
